...
E struct obj *obj_nexto_xy(int, int, int, unsigned);
...
E void role_menu_extra(int, winid);
...
E const char *shkname(struct monst *);
...
E void formatkiller(char *, unsigned, int);
